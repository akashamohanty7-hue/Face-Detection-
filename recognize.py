...
classifier = cv2.CascadeClassifier("C:/Users/akash/Desktop/face recognition/face recognition/haarcascade_frontalface_default.xml")

model = load_model("C:/Users/akash/Desktop/face recognition/face recognition/final_model (1).h5")

URL = 'http://192.0.0.4:8080/shot.jpg'

def get_pred_label(pred):
    labels = ['Akash', 'Litu', 'biswajeet']
    return labels[pred]
